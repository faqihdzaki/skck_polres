...
<head>
  ...
  <script src="{{ asset('assets/css/templatemo_style.css') }}"></script>
...
<body>
  ...
  <nav class="main-menu shadow-top-down">
    <ul class="nav nav-pills nav-stacked">
      <li><a href="{{url('login')}}" class="scroll_effect">Login</a></li>
      <li><a href="{{url('register')}}" class="scroll_effect">Register</a></li>
      <li><a href="{{url('admin.home')}}" class="scroll_effect"><i class="flag flag-indonesia"></i></a></li>
      <li><a href="{{url('admin.homeEn')}}" class="scroll_effect"><i class="flag flag-united-kingdom"></i></a></li>
    </ul>
  </nav>
  <!-- Home -->
  <section id="templatemo_home">
    <div class="container">
      ...
      <div class="templatemo_home_inner_wapper btn_wapper">
        <div class="col-sm-12">
          <a href="{{url('admin.dashboard')}}" class="btn col-xs-12 scroll_effect shadow-top-down">
            LEARN MORE
          </a>
        </div>
      </div>
