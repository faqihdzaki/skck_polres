<aside id="sidebar-wrapper">
  ...
  <ul class="sidebar-menu">
      ...
      <li class="{{ Request::route()->getName() == 'admin.takeawayhistory' ? ' active' : '' }}"><a class="nav-link" href="{{ route('admin.takeawayhistory') }}"><i class="fas fa-sticky-note"></i></i> <span>Take Away History</span></a>
