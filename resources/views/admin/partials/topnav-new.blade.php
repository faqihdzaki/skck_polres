<form class="form-inline mr-auto" action="">
  <!-- <ul class="navbar-nav mr-3">
    ...
    <li><a href="#" data-toggle="" class="nav-link nav-link-lg d-sm-none"><i class="fas fa-search"></i></a></li>
  </ul> -->
  <!-- <div class="search-element">
    <input class="form-control" value="" name="query" type="" placeholder="" aria-label="" data-width="250">
    <button class="btn" type="submit"><i class="fas fa-search"></i></button>
    <div class="search-backdrop"></div>
    {{-- ('admin.partials.searchhistory') --}}
  </div> -->
</form>
