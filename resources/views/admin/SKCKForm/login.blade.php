...
<form method="POST" action="/SKCKForm" class="needs-validation" novalidate="" id="skck">
@csrf      
...
<!-- <div class="form-group">
    ...
    <button type="submit" class="btn btn-primary btn-lg btn-icon icon-right" tabindex="4" form="skck">
        Next
    </button>
</div>
