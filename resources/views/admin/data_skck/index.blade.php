            ...
            <div class="card-body">
              <table class="table table-striped table-responsive">
                ...
                <tbody>
                  ...
                  ?></td> 
                    <td>
                      <a href="{{Route('admin.dataskckedit')}}/{{ $r->id }}" class="m-1 badge bg-primary text-white">Edit</a>
                      <a href="{{Route('admin.dataskckshow')}}/{{ $r->id }}" class="m-1 badge bg-info text-white">View</a>
                      <a href="{{Route('admin.dataskckdelete')}}/{{ $r->id }}" class="m-1 badge bg-danger text-white delete" id="">Delete</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
