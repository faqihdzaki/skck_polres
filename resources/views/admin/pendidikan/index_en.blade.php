      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="owl-carousel owl-theme" id="products-carousel">
            <form method="POST" action="{{route('admin.offense_en')}}" style="width:100%" id="school">
              @csrf
              <div class="row ">
                <div class="col-sm-9">
                  <label>School</label>
              ...
              <div class="">
                <div class="form-group">
                  <div>
                    <a class="btn btn-success m-1 text-white" id="add" onclick="add()">Add</a>
                  </div>
                </div>
              </div>
              <div class="card-footer text-right">
            <a href= "{{route('admin.couple')}}"class="btn btn-secondary" type="reset">Back</a>
