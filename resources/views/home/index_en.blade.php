...
<body>
  ...
  <nav class="main-menu shadow-top-down">
    <ul class="nav nav-pills nav-stacked">
      <li><a href="" class="scroll_effect">Login</a></li>
      <li><a href="" class="scroll_effect">Register</a></li>
      <li><a href="" class="scroll_effect"><i class="flag flag-indonesia"></i></a></li>
      <li><a href="" class="scroll_effect"><i class="flag flag-united-kingdom"></i></a></li>
    </ul>
  </nav>
  <!-- Home -->
